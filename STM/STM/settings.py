...
SECRET_KEY = 'django-insecure-qr+sn(@-kx3_f^ki8q$4qx+=vxm%t76+oii^sny5#vq-d9+p$-'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['STM/templates','StemApp/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_DIRS=[
    ...
    os.path.join(BASE_DIR,'StemApp/static')
]
...
# Sending Email Through STEMPVT@GMAIL.COM
# EMAIL_HOST='smtp.gmail.com'
# EMAIL_PORT=587
# EMAIL_HOST_USER='stempvt@gmail.com'
# EMAIL_HOST_PASSWORD='stem2021'
# EMAIL_USE_TLS=True
# DEFAULT_FROM_EMAIL="STEM(Student Education Managemnt <stempvt@gmail.com>"
